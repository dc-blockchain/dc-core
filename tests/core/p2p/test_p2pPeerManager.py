...
from tests.misc.helper import set_dc_dir
...
def make_node_chain_state():
    node_chain_state = dc_pb2.NodeChainState(block_number=0,
                                              header_hash=b'',
...
class TestP2PPeerManager(TestCase):
    ...
    def test_load_peer_addresses_peer_dc(self):
        """
        Should load peers from peers.dc AND from config.user.peer_list
        """
        with set_dc_dir('peers') as tmp_dir:
            self.peer_manager.peers_path = os.path.join(tmp_dir, 'peers.json')

            self.peer_manager.load_peer_addresses()

            # This was in peers.dc
    ...
    def test_load_peer_addresses_no_file(self):
        """
        If no peers.dc exists, use config.user.peer_list
        """
        with set_dc_dir('no_data') as tmp_dir:
    ...
    @patch('dc.core.p2p.p2pPeerManager.logger', autospec=True)
    def test_load_peer_addresses_corrupt_file(self, logger):
        """
        If peers.dc is corrupt, load_peer_addresses should rewrite it with valid peers from config.user.peer_list
        """
        with set_dc_dir('peers') as tmp_dir:
    ...
    def test_update_peer_addresses_also_connects_to_new_peers(self, logger):
        ...
        with set_dc_dir('no_data') as tempdir:
    ...
    def test_handle_version(self):
        ...
        message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.VE,
    ...
    def test_handle_version_empty_version_message(self):
        ...
        message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.VE,
                                              veData=dclegacy_pb2.VEData(version='',
                                                                          genesis_prev_hash=config.user.genesis_prev_headerhash,
                                                                          rate_limit=config.user.peer_rate_limit))
        self.peer_manager.handle_version(channel, message)
    ...
    def test_handle_peer_list_works(self, logger):
        ...
        """
        peer_list_message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.PL,
                                                        plData=dclegacy_pb2.PLData(
    ...
    def test_handle_peer_list_empty_peer_list_message(self, logger):
        ...
        """
        peer_list_message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.PL,
                                                        plData=dclegacy_pb2.PLData(peer_ips={}, public_port=9000))
        channel = make_channel()
    ...
    @patch('dc.core.p2p.p2pPeerManager.logger', autospec=True)
    @patch('dc.core.p2p.p2pPeerManager.config', autospec=True)
    ...
    def test_handle_sync(self):
        ...
        """
        sync_message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=dclegacy_pb2.SYNCData(state='Synced'))
        channel = make_channel()
    ...
    def test_handle_sync_unsynced(self):
        ...
        """
        sync_message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=dclegacy_pb2.SYNCData(state='Unsynced'))
        channel = make_channel()
    ...
    def test_handle_sync_blank(self):
        ...
        """
        sync_message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=dclegacy_pb2.SYNCData(state=''))
        channel = make_channel()
    ...
    def test_handle_chain_state_works(self):
        ...
        chain_state_message = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.CHAINSTATE,
    ...
    def test_handle_p2p_acknowledgement(self):
        ...
        """
        ack = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.P2P_ACK,
                                          p2pAckData=dc_pb2.P2PAcknowledgement(bytes_processed=15))
        channel = make_channel()
    ...
    def test_handle_p2p_acknowledgement_negative_bytes_processed(self):
        ...
        """
        ack = dclegacy_pb2.LegacyMessage(func_name=dclegacy_pb2.LegacyMessage.P2P_ACK,
                                          p2pAckData=dc_pb2.P2PAcknowledgement(bytes_processed=20))
        channel = make_channel()
    ...
    @patch('dc.core.p2p.p2pprotocol.P2PProtocol.peer')
    @patch('dc.core.p2p.p2pprotocol.P2PProtocol.send')
    def test_trusted_message_count(self, send, get_peer):
        channel = P2PProtocol()
        with mock.patch('dc.core.misc.ntp.getTime') as time_mock:
            ...
            for _ in range(config.dev.trust_min_msdcount - 1):
    ...
    def test_trusted_time(self, send, get_peer):
        ...
        with mock.patch('dc.core.misc.ntp.getTime') as time_mock:
            ...
            for _ in range(config.dev.trust_min_msdcount):
                buffer = bytes(hstr2bin('000000191a170a0776657273696f6e120c67656e657369735f68617368'))
                channel.dataReceived(buffer)
