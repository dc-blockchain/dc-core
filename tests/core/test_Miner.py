...
from dc.core.Miner import Miner
from dc.core.TransactionPool import TransactionPool
from dc.core.misc.helper import parse_qaddress
...
class TestMiner(TestCase):
    ...
    def test_start_mining_works(self, m_getTime, m_logger):
        ...
        with patch('dc.core.miners.qryptonight7.CNv1Miner.CNv1Miner.start', spec=True) as m_start:
...
class TestMinerWithRealTransactionPool(TestCase):
    ...
    @patch('dc.core.Miner.Block.create')
