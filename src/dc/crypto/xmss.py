...
from pydclib import pydclib
from pydclib.pydclib import bin2hstr, getRandomSeed, str2bin, bin2mnemonic, mnemonic2bin  # noqa
from pydclib.pydclib import XmssFast, dcDescriptor

hash_functions = {
    "shake128": pydclib.SHAKE_128,
    "shake256": pydclib.SHAKE_256,
    "sha2_256": pydclib.SHA2_256
}
...
class XMSS(object):
    ...
    def from_extended_seed(extended_seed: bytes):
        ...
        descr = dcDescriptor.fromBytes(extended_seed[0:3])
        if descr.getSignatureType() != pydclib.XMSS:
    ...
    def __init__(self, _xmssfast):
        ...
        >>> from dc.crypto.doctest_data import *
