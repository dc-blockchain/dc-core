...
_GETBLOCKMININdcOMPATIBLEREQ = _descriptor.Descriptor(
  name='GetBlockMiningCompatibleReq',
  full_name='dc.GetBlockMiningCompatibleReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='dc.GetBlockMiningCompatibleReq.height', index=0,
...
_GETLASTBLOCKHEADERREQ = _descriptor.Descriptor(
  ...
  full_name='dc.GetLastBlockHeaderReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='dc.GetLastBlockHeaderReq.height', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETBLOCKMININdcOMPATIBLERESP = _descriptor.Descriptor(
  name='GetBlockMiningCompatibleResp',
  full_name='dc.GetBlockMiningCompatibleResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='blockheader', full_name='dc.GetBlockMiningCompatibleResp.blockheader', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='blockmetadata', full_name='dc.GetBlockMiningCompatibleResp.blockmetadata', index=1,
...
_GETLASTBLOCKHEADERRESP = _descriptor.Descriptor(
  ...
  full_name='dc.GetLastBlockHeaderResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='difficulty', full_name='dc.GetLastBlockHeaderResp.difficulty', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='dc.GetLastBlockHeaderResp.height', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='dc.GetLastBlockHeaderResp.timestamp', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reward', full_name='dc.GetLastBlockHeaderResp.reward', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hash', full_name='dc.GetLastBlockHeaderResp.hash', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='depth', full_name='dc.GetLastBlockHeaderResp.depth', index=5,
...
_GETBLOCKTOMINEREQ = _descriptor.Descriptor(
  ...
  full_name='dc.GetBlockToMineReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='wallet_address', full_name='dc.GetBlockToMineReq.wallet_address', index=0,
...
_GETBLOCKTOMINERESP = _descriptor.Descriptor(
  ...
  full_name='dc.GetBlockToMineResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='blocktemplate_blob', full_name='dc.GetBlockToMineResp.blocktemplate_blob', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='difficulty', full_name='dc.GetBlockToMineResp.difficulty', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='dc.GetBlockToMineResp.height', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reserved_offset', full_name='dc.GetBlockToMineResp.reserved_offset', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='seed_hash', full_name='dc.GetBlockToMineResp.seed_hash', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBMITMINEDBLOCKREQ = _descriptor.Descriptor(
  ...
  full_name='dc.SubmitMinedBlockReq',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='blob', full_name='dc.SubmitMinedBlockReq.blob', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBMITMINEDBLOCKRESP = _descriptor.Descriptor(
  ...
  full_name='dc.SubmitMinedBlockResp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error', full_name='dc.SubmitMinedBlockResp.error', index=0,
...
_GETBLOCKMININdcOMPATIBLERESP.fields_by_name['blockheader'].message_type = dc__pb2._BLOCKHEADER
_GETBLOCKMININdcOMPATIBLERESP.fields_by_name['blockmetadata'].message_type = dc__pb2._BLOCKMETADATA
DESCRIPTOR.message_types_by_name['GetBlockMiningCompatibleReq'] = _GETBLOCKMININdcOMPATIBLEREQ
DESCRIPTOR.message_types_by_name['GetLastBlockHeaderReq'] = _GETLASTBLOCKHEADERREQ
DESCRIPTOR.message_types_by_name['GetBlockMiningCompatibleResp'] = _GETBLOCKMININdcOMPATIBLERESP
...
GetBlockMiningCompatibleReq = _reflection.GeneratedProtocolMessageType('GetBlockMiningCompatibleReq', (_message.Message,), dict(
  DESCRIPTOR = _GETBLOCKMININdcOMPATIBLEREQ,
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.GetBlockMiningCompatibleReq)
  ))
...
GetLastBlockHeaderReq = _reflection.GeneratedProtocolMessageType('GetLastBlockHeaderReq', (_message.Message,), dict(
  ...
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.GetLastBlockHeaderReq)
  ))
...
GetBlockMiningCompatibleResp = _reflection.GeneratedProtocolMessageType('GetBlockMiningCompatibleResp', (_message.Message,), dict(
  DESCRIPTOR = _GETBLOCKMININdcOMPATIBLERESP,
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.GetBlockMiningCompatibleResp)
  ))
...
GetLastBlockHeaderResp = _reflection.GeneratedProtocolMessageType('GetLastBlockHeaderResp', (_message.Message,), dict(
  ...
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.GetLastBlockHeaderResp)
  ))
...
GetBlockToMineReq = _reflection.GeneratedProtocolMessageType('GetBlockToMineReq', (_message.Message,), dict(
  ...
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.GetBlockToMineReq)
  ))
...
GetBlockToMineResp = _reflection.GeneratedProtocolMessageType('GetBlockToMineResp', (_message.Message,), dict(
  ...
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.GetBlockToMineResp)
  ))
...
SubmitMinedBlockReq = _reflection.GeneratedProtocolMessageType('SubmitMinedBlockReq', (_message.Message,), dict(
  ...
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.SubmitMinedBlockReq)
  ))
...
SubmitMinedBlockResp = _reflection.GeneratedProtocolMessageType('SubmitMinedBlockResp', (_message.Message,), dict(
  ...
  __module__ = 'dcmining_pb2'
  # @@protoc_insertion_point(class_scope:dc.SubmitMinedBlockResp)
  ))
...
_MININGAPI = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='dc.MiningAPI.GetBlockMiningCompatible',
    index=0,
    containing_service=None,
    input_type=_GETBLOCKMININdcOMPATIBLEREQ,
    output_type=_GETBLOCKMININdcOMPATIBLERESP,
    options=None,
  ),
  _descriptor.MethodDescriptor(
    name='GetLastBlockHeader',
    full_name='dc.MiningAPI.GetLastBlockHeader',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetBlockToMine',
    full_name='dc.MiningAPI.GetBlockToMine',
    index=2,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='dc.MiningAPI.SubmitMinedBlock',
    index=3,
    containing_service=None,
