...
from pydclib.pydclib import dcHelper, hstr2bin, sha2_256
...
class MultiSigAddressState(object):
    def __init__(self, protobuf_block=None):
        ...
        if protobuf_block is None:
            self._data = dc_pb2.MultiSigAddressState()
    ...
    def pbdata(self):
        ...
        :rtype: dc_pb2.MultiSigAddressState
        """
        return self._data
    ...
    def address_is_valid(address: bytes) -> bool:
        ...
        if not dcHelper.addressIsValid(address):
            return False
    ...
    def get_multi_sig_address_state(state: State,
        ...
        try:
            ...
            pbdata = dc_pb2.MultiSigAddressState()
