...
from dc.generated.dclegacy_pb2 import LegacyMessage
...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        dclegacy_pb2.LegacyMessage.VE: 'veData',
        dclegacy_pb2.LegacyMessage.PL: 'plData',
        dclegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        dclegacy_pb2.LegacyMessage.MR: 'mrData',
        dclegacy_pb2.LegacyMessage.SFM: 'mrData',

        dclegacy_pb2.LegacyMessage.BK: 'block',
        dclegacy_pb2.LegacyMessage.FB: 'fbData',
        dclegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        dclegacy_pb2.LegacyMessage.TX: 'txData',
        dclegacy_pb2.LegacyMessage.MT: 'mtData',
        dclegacy_pb2.LegacyMessage.TK: 'tkData',
        dclegacy_pb2.LegacyMessage.TT: 'ttData',
        dclegacy_pb2.LegacyMessage.LT: 'ltData',
        dclegacy_pb2.LegacyMessage.SL: 'slData',

        dclegacy_pb2.LegacyMessage.EPH: 'ephData',

        dclegacy_pb2.LegacyMessage.SYNC: 'syncData',

        dclegacy_pb2.LegacyMessage.MC: 'mcData',
        dclegacy_pb2.LegacyMessage.MS: 'msData',
        dclegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[dclegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = dclegacy_pb2.LegacyMessage(**{'func_name': msg_type,
